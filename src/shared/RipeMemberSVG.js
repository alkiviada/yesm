...
class RipeMemberSVG extends Component {
  render() {
    return (
...
<g>
	...
	<path className="st0" d="M356.6,297.9v-86.1h21.6v86.1H356.6z"/>
	<path className="st0" d="M432.3,268.1h-17.9v29.8h-21.5v-86.1h38.9c19.1,0,30.2,11.7,30.2,27.7C462,253.6,453.3,268.1,432.3,268.1z
		 M428.3,228.7h-13.9v22.8h13.9c7.4,0,12.6-3.9,12.6-11.6C440.8,232.5,436,228.7,428.3,228.7z"/>
	<path className="st0" d="M472.8,297.9v-86.1h63.4v17.5h-41.9v16.4h35.3v17.4h-35.3v17.1h42.1v17.6H472.8z"/>
	<path className="st0" d="M633.9,297.9l-33.7-50.6H600v50.6H580v-86.1h20.9l32.7,48.7h0.2v-48.7h20v86.1H633.9z"/>
	<path className="st0" d="M703.1,299.4c-19,0-36.7-9.5-36.7-31v-26.2c0-21.1,17.1-31.8,36.1-31.8c16.8,0,35,8.5,35,28.4v4.1h-20.3v-2.1
	...
	<path className="st0" d="M784.1,299.4c-19,0-36.7-9.5-36.7-31v-26.2c0-21.1,17.1-31.8,36.1-31.8c16.8,0,35,8.5,35,28.4v4.1h-20.3v-2.1
		c0-8.9-7.6-12.8-14.2-12.8c-7.6,0-15,4-15,13.8v26.1c0,8.8,6.4,13.9,15.2,13.9c6.6,0,14-3.7,14-12.8v-2.1h20.3v4.2
...
<linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="50.2333" y1="394.3012" x2="208.0133" y2="236.5212">
	<stop  offset="0" style={{'stopColor':"#25316A"}}/>
	<stop  offset="6.051821e-02" style={{'stopColor':"#293269"}}/>
	<stop  offset="0.1216" style={{'stopColor':"#343468"}}/>
	<stop  offset="0.183" style={{"stopColor":"#453764"}}/>
	<stop  offset="0.2446" style={{"stopColor":"#5B3C60"}}/>
	<stop  offset="0.3064" style={{"stopColor":"#764459"}}/>
	<stop  offset="0.3684" style={{"stopColor":"#964D4F"}}/>
	<stop  offset="0.4293" style={{"stopColor":"#BF5A3D"}}/>
	<stop  offset="0.4872" style={{"stopColor":"#F36C21"}}/>
	<stop  offset="1" style={{"stopColor":"#9C9C9C"}}/>
</linearGradient>
<path className="st1" d="M184.5,272.6L184.5,272.6l0-59.6l-55.3-32l-55.3,32l0,59.5l0,0.1l-51.6,29.8l0,63.9l55.3,32l51.6-29.8
...
<g>
	<path className="st2" d="M294.5,364.9L280,327.1h-0.2c0.3,3,0.4,6.6,0.4,10.7v27.1h-4.6v-42.6h7.5l13.5,35.2h0.2l13.6-35.2h7.4v42.6h-5
		v-27.5c0-3.1,0.1-6.6,0.4-10.3h-0.2l-14.6,37.7H294.5z"/>
	<path className="st2" d="M342.3,365.5c-4.7,0-8.5-1.4-11.2-4.3c-2.7-2.9-4.1-6.9-4.1-12c0-5.2,1.3-9.2,3.8-12.3s5.9-4.5,10.2-4.5
	...
	<path className="st2" d="M403,364.9v-20.8c0-2.5-0.5-4.5-1.6-5.7c-1.1-1.3-2.8-1.9-5.1-1.9c-3,0-5.2,0.9-6.7,2.6
	...
	<path className="st2" d="M432.7,332.4c4.2,0,7.5,1.4,9.8,4.3c2.3,2.9,3.5,6.9,3.5,12.2s-1.2,9.3-3.5,12.2c-2.3,2.9-5.6,4.4-9.8,4.4
		...
		/>
	<path className="st2" d="M467.9,365.5c-4.7,0-8.5-1.4-11.2-4.3c-2.7-2.9-4.1-6.9-4.1-12c0-5.2,1.3-9.2,3.8-12.3c2.5-3,5.9-4.5,10.2-4.5
		c4,0,7.2,1.3,9.5,4c2.3,2.6,3.5,6.1,3.5,10.4v3.1h-22c0.1,3.8,1,6.6,2.8,8.5s4.3,2.9,7.6,2.9c3.4,0,6.8-0.7,10.2-2.2v4.3
	...
	<path className="st2" d="M502.5,332.4c1.4,0,2.7,0.1,3.8,0.3l-0.7,4.5c-1.3-0.3-2.5-0.4-3.5-0.4c-2.6,0-4.8,1-6.6,3.1
