  ...
  render() {
    ...
    return (
      <svg viewBox="-5 -3 26 24.4" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="100%" height="100%" className={className}> 
        ...
        <path id="bname-subhead1" d="M -2.8 8.1 L 13.5 8.1" className="yesm-subhead-path"/>
        <path id="bname-subhead2" d="M -2.8 11.2 L 18 11.2" className="yesm-subhead-path"/>
        </defs>
        ...
        <text className="yesm-bname-subhead-text" textLength="18">
